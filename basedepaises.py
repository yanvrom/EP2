from normalizafunc import normaliza
import json
...
basenormalizada = normaliza(DADOS)
basenormalizadastr = json.dumps(basenormalizada)

with open('basenormalizada.py', 'w') as arq:
  arq.write(basenormalizadastr)
